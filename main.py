...
async def event_stream(card_str, site_url, proxy_str):
    try:
        ...
        # Elakkan stream crash jika ada error tidak dijangka di engine
...
async def check_card(request: Request):
    ...
    # StreamingResponse untuk hantar data secara real-time
    return StreamingResponse(
        ...
        headers={
            ...
            "X-Accel-Buffering": "no", # Penting: Elakkan Nginx/Railway buffer stream
        }
    )

if __name__ == "__main__":
    import uvicorn
    # timeout_keep_alive=300 untuk bagi masa 5 minit kepada proses
